...
class StockRecordController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        //$grid->column('measurment_unit', __('Measurment unit'));
    ...
    protected function detail($id)
    {
        ...
        $show->field('measurment_unit', __('Measurment unit'));
    ...
    protected function form()
    {
        ...
        // $sub_cat_ajax_url = url('api/stock-items');
        $sub_items_ajax_url = url('api/stock-items')
            . '?company_id=' . $u->company_id;
        ...
        //$form->text('measurment_unit', __('Measurment unit'));
        ...
        $form->decimal('quantity', __('Quantity (Unist'))->rules('required |numeric|min:1 ');
